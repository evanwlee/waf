...
com.evanwlee.web.hos.view.PagingOpportunityView,
com.evanwlee.web.view.View"%>
		...
		<!-- Portlet Center-->
			<div id="centerPortlet" style="width:600px; position: absolute; left: 160px; top:5px; height: 400px; ">
				...
				<div id="header" class="portletHeaderDiv" >
					<span class="portletHeaderFont">Add Opportunity</span>
				</div>
				
				<!-- Portlet BODY -->
				<table border="0" cellpadding="0" cellspacing="0" style="width:100%; border-top:0px; border-bottom:0px; border-right: 1px solid #CCB78F;border-left: 1px solid #CCB78F; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
					<tr>
						<td width="60%" nowrap  valign="center" style="background-color:#ACC8A8">
						&nbsp;
						</td>
					</tr>
				</table>
				...
				<input name="<%=Action.ACTION_ID%>" id="<%=Action.ACTION_ID%>" value="" type="hidden"/>
					<table border="0" cellpadding="0" cellspacing="0" style="width:100%; border-top:0px; border-bottom:0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
						<tr>
							...
							<td width="75%" >
								<input name="<%=PagingOpportunityView.fld_DESCRIPTION%>" id="<%=PagingOpportunityView.fld_DESCRIPTION%>" type="text" class="formField"></input>
							</td>
						</tr>
						<tr>
							<td width="25%" valign="top">
							...
							<td width="75%" >
								<textarea cols="50" rows="3" name="<%=PagingOpportunityView.fld_TEXT%>" id="<%=PagingOpportunityView.fld_TEXT%>" style="width: 98%; border:1px #999 solid;" onKeyUp="checkStatus(this,'<%=OpportunityView.MAX_ENTRY_LENGTH%>');" onKeyDown="checkStatus(this,'<%=OpportunityView.MAX_ENTRY_LENGTH%>');"></textarea>
						...
						<tr>
							<td width="25%" nowrap align="right"><%=View.renderSubmitButton("addEntry",Action.ADD_OPP,"Post","","loginButton","Post",user)%></td>
